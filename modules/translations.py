...
help_message = {
    'en': 'Thank you for using the {0} Tip Bot!  Below is a list of commands, and a description of what they do:\n\n'
          ...
          + BULLET + '!tip: Tips are sent through public tweets or in Telegram groups.\n'
                     ...
                     ' On Telegram send {1} !tip <amount> <@username> to tip in the group.\n\n'
    ...
    'es': '¡Gracias por usar el {0} Tip Bot!\n'
          ...
          + BULLET + ' !tip: Los tips se envían a través de tweets públicos o en grupos de Telegram.\n'
                     ...
                     'En Telegram: Envía {1} !tip <monto> <@usuario> para realizar un tip en el grupo.\n\n'
    ...
    'nl': 'Bedankt voor het gebruik van de {0} Tip Bot! Hieronder staat een lijst met opdrachten en een '
          ...
          + BULLET + ' !tip: Tips worden verzonden via openbare tweets of in Telegram-groepen.\n'
                     ...
                     'Op Telegram stuur {1} !tip <aantal> <@gebruikersnaam> om iemand een ​​tip te geven in de groep.\n\n'
          ...
          + BULLET + ' !account: Toont het accountnummer dat gekoppeld is aan jouw gebruikers-ID '
                     '(momenteel uniek voor het platform). Je kan dit adres gebruiken om er meer {0} op te '
                     'storten, zodat je een tip kan sturen vanuit jouw persoonlijke account.\n\n'
          + BULLET + ' !withdraw: Correct gebruik is !withdraw {2}. Hiermee wordt het volledige saldo van '
                     'jouw tip-account naar het door jou opgegeven {0}-account verzonden. '
                     'Optioneel: je kan een specifiek bedrag opnemen door het verzenden van '
                     '!withdraw <bedrag> <adres>. Voorbeeld: !withdraw 1 {2} zou 1 {0} '
                     'opnemen en versturen naar rekening {2}.\n\n'
          + BULLET + ' !donate: correct gebruik is !donate 1234. Hiermee wordt de gevraagde donatie naar de '
                     '{0} Tip Bot-donatierekening verzonden om goede initiatieven te helpen financieren.\n\n'
    ...
    'fr': 'Nous vous remercions d\'utiliser le Tip Bot de {0}! Ci-dessous se trouve une liste des fonctions, ainsi '
          ...
          + BULLET + '!tip: Les tips sont envoyés via les tweets publics ou au sein de groupes Telegram.\n'
                     ...
                     'Sur Telegram, envoyez {1} !tip <montant> <@utilisateur> afin d\'envoyer un tip dans le groupe.\n\n'
    ...
    'pt': 'Obrigado por utilizar o {0} Tip Bot! Os comandos disponíveis são:\n\n'
          ...
          + BULLET + ' !tip: As tips são gorjetas enviadas através de tweets públicos ou em grupos do Telegram.\n'
                     ...
                     'No Telegram, envia {1} !tip <valor> <@utilizador> no grupo.\n\n'
    ...
    'id': 'Terima kasih telah menggunakan {0} Tip Bot! Di bawah ini adalah daftar perintah, dan deskripsi tentang apa '
          ...
          + BULLET + ' !tip: Tip dikirim melalui tweet publik atau dalam grup Telegram.\n'
                     ...
                     'Di Telegram, kirim {1} !tip <amount> <@username> untuk memberi tip di grup.\n\n'
    ...
    'ru': 'Спасибо за использование {0} Tip Bot! Ниже приведен список команд и описание того, что они делают:\n\n'
          ...
          + BULLET + ' !тип: Тип отправляются через публичные твиты или в группах Telegram.\n'
                     ...
                     'В Telegram отправьте {1} !тип <сумма> <@имя_пользователя> , чтобы сделать тип в группе.\n\n'
    ...
    'it': 'Grazie di utilizzare {0} Tip Bot! Qui sotto trovi una lista di comandi, e una '
          ...
          + BULLET + ' !tip: Le mance vengono inviate attraverso tweets pubblici o nei gruppi Telegram.\n'
                     ...
                     'Su Telegram invia {1} !tip <importo> <@nomeutente> per dare una mancia nel gruppo.\n\n'
