...
help_message = {
    ...
    'es': '¡Gracias por usar el Nano Tip Bot!  Debajo hay una lista de comandos junto con una descripción de lo que '
          'cada uno hace.\n\n'
          + BULLET + ' !help: El tip bot va a responder a tu mensaje directo con una lista de comandos y sus '
                     'funciones. Si olvidas algo, usa esto para tener una pista de cómo hacerlo.\n\n'
          + BULLET + ' !register: Registra tu ID de usuario a una cuenta que esté vinculada a este. Esto se '
                     'utiliza para almacenar tus tips. Asegúrate de retirar tus fondos a una billetera privada, ya '
          ...
          + BULLET + ' !tip: Los tips se envían a través de tweets públicos o en grupos de Telegram.\n'
                     ' En Twitter: Etiqueta a @NanoTipBot en un tweet y menciona !tip <monto> <@usuario>. '
                     'Ejemplo: @NanoTipBot !tip 1 @mitche50 enviaría un tip de 1 NANO al usuario @mitche50.\n'
          ...
          + BULLET + ' !account: Recibirás el número de cuenta que está vinculado a tu ID de usuario (actualmente '
                     'exclusivo de la plataforma). Puedes usar esto para depositar más NANO para realizar tips de tu '
                     'billetera personal.\n\n'
          + BULLET + ' !withdraw: El uso adecuado es !withdraw xrb_12345. Esto enviará el saldo completo de tu cuenta '
                     'de tips a la cuenta NANO provista. Opcional: Puedes incluir una cantidad para retirar '
                     'utilizando !withdraw <cantidad> <cuenta>. Ejemplo: !withdraw 1 xrb_iaoia83if221lodoepq '
                     'retiraría 1 NANO a la cuenta xrb_iaoia83if221lodoepq.\n\n'
          + BULLET + ' !donate: El uso adecuado es !donate 1234. Esto enviará la donación solicitada a la cuenta de '
                     'donación del Nano Tip Bot para ayudar a financiar los esfuerzos de desarrollo.\n\n'
          + BULLET + ' !setlanguage: Se usa para cambiar el idioma predeterminando del bot. El uso correcto es: '
                     '!setlanguage Russian, lo que cambiaría  tu idioma al ruso.\n\n'
          + BULLET + ' !languages: Te muestra una lista de idiomas disponibles para traducción.',
