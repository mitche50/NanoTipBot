...
wrong_donate_text = {
    ...
    'id': '',
    'vt': '',
    'ru': 'Принимаются только цифровые суммы. Пожалуйста, отправьте как !donate 1234',
    'sv': '',
...
incorrect_donate_text = {
    ...
    'id': '',
    'vt': '',
    'ru': 'Неверный синтаксис. Пожалуйста, используйте формат !donate 1234',
    'sv': '',
...
language_change_success = {
    ...
    'ru': 'Вы успешно обновили свой язык. Сообщение, которое вы получите от бота, теперь будет на вашем новом языке. '
          'Если вы хотите вернуться обратно, отправьте команду !setlanguage с новым языком!',
    'sv': '',
...
missing_language = {
    ...
    'id': '',
    'vt': '',
    'ru': 'Этот язык не доступен для переводов, отправьте !languagelist для списка языков и кодов.',
    'sv': '',
